...
import { useModals } from "@/app/_context/ModalContext";

interface SurahGroupLayoutProps {
  children: React.ReactNode;
}

export default function SurahGroupLayout({ children }: SurahGroupLayoutProps) {
  const { settingsOpen, setSettingsOpen, surahOpen, setSurahOpen } =
    useModals();
